...
/**
 * Clase JuegoPareja. Esta formada por el main, el m�todo jugar(), el m�todo
 * resolver() y el m�todo verSiFin(). Contiene un objeto de la clase
 * TableroParejas.
 * 
...
public class JuegoPareja {
	...
	/**
	 * M�todo que se encarga de pedir una fila y una columna para descubrir una
	 * celda y pedir seguidamente otra fila y columna para descubrir la segunda
	 * celda. Cambian su estado 1-mostrada y llama al los m�todos resolver() y
	 * verSiFin(). Con el objeto t de la clase Tablero, llamaremos a los m�todos
	 ...
	 * el tablero seg�n el numero de filas y columnas que decida el usuario, siempre
	 * y cuando su multiplicaci�n sea par.
	 * 
	 * @param sc
	 */
	...
	/**
	 * M�todo que se encarga de comprobar el contenido de imagenFrontal si es igual
	...
	/**
	 * M�todo que comprueba si el estado de todas las celdas del tablero es igual a
	 * 2 (todas emparejadas), si esto es asi devuelve true. De lo contrario retorna
	 * false, y por lo tanto seguir�a el juego hasta que se devuelva true.
	 * 
